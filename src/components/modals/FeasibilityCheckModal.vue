<template>
  ...
  >
    <template #body>
      ...
      <div
        class="d-flex flex-row mb-3 justify-content-between mt-5"
        style="min-height: 38px;"
      >
        <div
          data-bs-toggle="collapse"
          data-bs-target="#costEstimation"
          aria-controls="costEstimation"
          aria-expanded="true"
          type="button"
        >
        ...
        <div
          ...
          aria-expanded="false"
          type="button"
          class="cost-estimation-header justify-content-end pt-1"
        >
      ...
      >
        ...
        <div class="text-left mb-3">
          Is there a cost estimation uploaded for the actual costs in the folder or is the information detailled in the feasibility check template?
          (yes,separate table uploaded / cost calculation is explained is in the feasibility check template / task pending)
        </div>
        ...
        <div class="text-left mb-3">
          ...
          The new TNA sheet will be used until the end of the project anytime this is requested again, unless you indicate a change again..
        </div>
