<template>
    ...
    <div class="ui-configuration">
     <div class="theme mb-2">
        ...
        <div class="theme-config row collapse show" id="collapse1">
     ...
     <div class="nav-bar mb-2">
        ...
        <div class="navbar-config row collapse" id="collapse2">
            <h5 class="mb-3 bold text-muted">You can see the changes live in the navbar above!
    ...
    <div class="login mb-2">
        ...
        <div class="login-config row collapse" id="collapse3">
    ...
    <div class="filter mb-2">
        <div class="mb-3 text-left fw-bold h3">
            ...
            <button class="btn btn-sm btn-light" type="button" data-bs-toggle="collapse" data-bs-target="#collapse4" aria-expanded="false" aria-controls="collapse4">
                <i class="bi bi-arrows-angle-expand"/> expand/collapse
            </button>
        </div>
        <div class="filter-config row collapse mb-5" id="collapse4">
    ...
    <div class="negotiation-list mb-2">
        <div class="mb-3 text-left fw-bold h3">
            ...
            <button class="btn btn-sm btn-light" type="button" data-bs-toggle="collapse" data-bs-target="#collapse5" aria-expanded="false" aria-controls="collapse5">
                <i class="bi bi-arrows-angle-expand"/> expand/collapse
            </button>
        </div>
        <div class="negotiation-list-config row collapse mb-5" id="collapse5">
...
const filtersSortData = ref({ "status": [], "dateStart": "", "dateEnd": "", "sortBy": "creationDate", "sortDirection": "DESC" })
const userRole = ref('ROLE_ADMIN')
const filtersStatus = ref([ { "value": "SUBMITTED", "label": "Under review", "description": "The negotiation has been submitted for review", "_links": { "states": { "href": "http://localhost:8081/api/v3/negotiation-lifecycle/states" }, "self": { "href": "http://localhost:8081/api/v3/negotiation-lifecycle/states/SUBMITTED" } } }, { "value": "APPROVED", "label": "Approved", "description": "The negotiation has been approved", "_links": { "states": { "href": "http://localhost:8081/api/v3/negotiation-lifecycle/states" }, "self": { "href": "http://localhost:8081/api/v3/negotiation-lifecycle/states/APPROVED" } } }, { "value": "DECLINED", "label": "Declined", "description": "The negotiation has been declined", "_links": { "states": { "href": "http://localhost:8081/api/v3/negotiation-lifecycle/states" }, "self": { "href": "http://localhost:8081/api/v3/negotiation-lifecycle/states/DECLINED" } } }, { "value": "IN_PROGRESS", "label": "In Progress", "description": "The negotiation is currently in progress", "_links": { "states": { "href": "http://localhost:8081/api/v3/negotiation-lifecycle/states" }, "self": { "href": "http://localhost:8081/api/v3/negotiation-lifecycle/states/IN_PROGRESS" } } }, { "value": "ABANDONED", "label": "Abandoned", "description": "The negotiation has been abandoned", "_links": { "states": { "href": "http://localhost:8081/api/v3/negotiation-lifecycle/states" }, "self": { "href": "http://localhost:8081/api/v3/negotiation-lifecycle/states/ABANDONED" } } }, { "value": "CONCLUDED", "label": "Concluded", "description": "The negotiation has been concluded", "_links": { "states": { "href": "http://localhost:8081/api/v3/negotiation-lifecycle/states" }, "self": { "href": "http://localhost:8081/api/v3/negotiation-lifecycle/states/CONCLUDED" } } }, { "value": "PAUSED", "label": "Paused", "description": "The negotiation is paused", "_links": { "states": { "href": "http://localhost:8081/api/v3/negotiation-lifecycle/states" }, "self": { "href": "http://localhost:8081/api/v3/negotiation-lifecycle/states/PAUSED" } } } ])
