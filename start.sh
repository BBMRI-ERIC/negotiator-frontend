...
do
  ...
  sed -i 's|ACTIVE_THEME_PLACEHOLDER|'${ACTIVE_THEME}'|g' $file
  sed -i 's|ACTIVE_LOGOS_PLACEHOLDER|'${ACTIVE_LOGOS}'|g' $file
  sed -i 's|FOLLOW_US_VISIBLE_PLACEHOLDER|'${FOLLOW_US_VISIBLE}'|g' $file
