...
do
  ...
  sed -i 's|FEATURE_FLAG_LS_LOGIN_DOWN_WARNING_PLACEHOLDER|'${FEATURE_FLAG_LS_LOGIN_DOWN_WARNING:-false}'|g' $file
  sed -i 's|FEATURE_FLAG_LS_LOGIN_DOWN_WARNING_TEXT_PLACEHOLDER|'${FEATURE_FLAG_LS_LOGIN_DOWN_WARNING_TEXT:-"We're sorry, but we're having some technical difficulties. Please try again later."}'|g' $file
